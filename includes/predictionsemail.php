...
while ($row = mysqli_fetch_array($result))
{
	...
	$heading .= '<tr>' . chr(13);
	$heading .= '<td>' . chr(13);
	$heading .= '<img border="0" style="display: block; border: 1px solid #ccc; vertical-align: middle;" src="http://www.julianrimet.com/assets/img/flags/' . strtolower($row['HomeTeamS']) . '.png" />' . chr(13);
	$heading .= '</td>' . chr(13);
	...
	$heading .= '</td>' . chr(13);
	$heading .= '<td>' . chr(13);
	$heading .= '<img border="0" style="display: block; border: 1px solid #ccc; vertical-align: middle;" src="http://www.julianrimet.com/assets/img/flags/' . strtolower($row['AwayTeamS']) . '.png" />' . chr(13);
	$heading .= '</td>' . chr(13);
	$heading .= '</tr>' . chr(13);
