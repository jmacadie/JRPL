          ...
          <div class="panel panel-default">
            ...
            <div id="collapseTeam" class="panel-collapse collapse">
              <div class="panel-body">
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT1" value="" checked>
                  <strong>Arsenal</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT2" value="" checked>
                  <strong>Aston Villa</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT3" value="" checked>
                  <strong>Brighton &amp; Hove Albion</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT4" value="" checked>
                  <strong>Burnley</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT5" value="" checked>
                  <strong>Chelsea</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT6" value="" checked>
                  <strong>Crystal Palace</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT7" value="" checked>
                  <strong>Everton</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT8" value="" checked>
                  <strong>Fulham</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT9" value="" checked>
                  <strong>Leeds United</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT10" value="" checked>
                  <strong>Leicester City</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT11" value="" checked>
                  <strong>Liverpool</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT12" value="" checked>
                  <strong>Manchester City</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT13" value="" checked>
                  <strong>Manchester United</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT14" value="" checked>
                  <strong>Newcastle United</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT15" value="" checked>
                  <strong>Sheffield United</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT16" value="" checked>
                  <strong>Southampton</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT17" value="" checked>
                  <strong>Tottenham Hotspur</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT18" value="" checked>
                  <strong>West Bromwich Albion</strong><br />
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbT19" value="" checked>
          ...
          <div class="panel panel-default">
            ...
            <div id="collapseWeek" class="panel-collapse collapse">
              <div class="panel-body">
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW1" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW2" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW3" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW4" value="" checked>
                  <strong>Game Week 4</strong><br />
                  3<sup>rd</sup> October 2020 - 3<sup>rd</sup> October 2020
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW5" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW6" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW7" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW8" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW9" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW10" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW11" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW12" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW13" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW14" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW15" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW16" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW17" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW18" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW19" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW20" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW21" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW22" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW23" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW24" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW25" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW26" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW27" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW28" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW29" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW30" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW31" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW32" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW33" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW34" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW35" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW36" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW37" value="" checked>
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="ckbGW38" value="" checked>
