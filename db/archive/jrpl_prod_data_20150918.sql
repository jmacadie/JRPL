...
--
-- Truncate table before insert `Broadcaster`
--

TRUNCATE TABLE `Broadcaster`;
--
...
--
-- Truncate table before insert `Match`
--
...
--
-- Truncate table before insert `Prediction`
--
...
--
-- Truncate table before insert `RememberMe`
--
...
--
-- Truncate table before insert `ScoringSystem`
--

TRUNCATE TABLE `ScoringSystem`;
--
...
--
-- Truncate table before insert `Stage`
--
...
--
-- Truncate table before insert `TournamentRole`
--

TRUNCATE TABLE `TournamentRole`;
--
...
--
-- Truncate table before insert `UserRole`
--
